...
import type { SuggestionsData } from "../../types/core/suggestions";
...
class SuggestionService {
    ...
    /**
     * Loads code suggestions from local constant data
     */
    ...
    /**
     * Gets suggestions data and converts it to Suggestion array
     */
    private getSuggestionsData(): Suggestion[] {
        const SUGGESTIONS_DATA: SuggestionsData = {
            function: [
                ...
                },
                {
                    ...
                    documentation: "Compiles Lua code into a function that can be called later"
                },
                {
                    label: "cloneref",
                    detail: "(instance: Instance) -> Instance",
                    documentation: "Creates a reference to an instance that bypasses metatable redirections"
                },
                {
                ...
                },
                {
                    label: "task.wait",
                    detail: "(seconds?: number) -> number",
                    documentation: "Yields the current thread for the specified duration (more precise than wait())"
                },
                {
                    label: "task.spawn",
                ...
                },
                {
                    ...
                    documentation: "Dispatches a mouse scroll by the specified number of pixels"
                },
                {
                    label: "mousemoverel",
                    detail: "(x: number, y: number) -> ()",
                    documentation: "Adjusts the mouse cursor by the specified relative amount"
                },
                {
                    label: "mousemoveabs",
                    detail: "(x: number, y: number) -> ()",
                    documentation: "Moves the mouse cursor to the specified absolute position"
                },
                {
                    label: "setclipboard",
                    detail: "(text: string) -> ()",
                ...
                },
                {
                    label: "setfpscap",
                    detail: "(fps: number) -> ()",
                    documentation: "Sets the in-game FPS cap to fps. If fps is 0, the FPS cap is disabled"
                },
                {
            ...
            property: [
                ...
                },
                {
                    ...
                    documentation: "Core GUI service for managing Roblox's built-in interface elements"
                },
                {
        ...
        SUGGESTIONS_DATA.function.forEach(item => {
            suggestions.push({
                type: "function",
                label: item.label,
                detail: item.detail,
        ...
        SUGGESTIONS_DATA.property.forEach(item => {
            suggestions.push({
                type: "property",
                label: item.label,
                detail: item.detail,
        ...
        SUGGESTIONS_DATA.class.forEach(item => {
            suggestions.push({
                type: "class",
                label: item.label,
                detail: item.detail,
        ...
        SUGGESTIONS_DATA.method.forEach(item => {
            suggestions.push({
                type: "method",
                label: item.label,
                detail: item.detail,
