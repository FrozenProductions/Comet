...
export const CATEGORIES: Record<string, FastFlagCategory> = {
    graphics: {
        id: "graphics",
        label: "Graphics",
        ...
        flags: [
            ...
            {
                key: "FIntDebugTextureManagerSkipMips",
                label: "Texture Quality",
                description:
                    "Controls the quality of textures. Higher values improve performance while lower values enhance visual quality.",
                type: "slider",
                defaultValue: 1,
                min: 1,
                max: 8,
    ...
    lighting: {
        id: "lighting",
        label: "Lighting",
        description: "Lighting and shadow quality settings",
        flags: [
            {
