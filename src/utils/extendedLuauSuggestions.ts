...
export const luaTableOperations: Suggestion[] = [
    ...
    },
    {
        ...
        documentation:
            "Creates a new table with n elements initialized with value",
    },
    {
        type: "function",
        label: "table.find",
...
export const inputFunctions: Suggestion[] = [
    {
        ...
        detail: "() -> boolean",
        documentation:
            "Checks if the Roblox window is currently active/focused",
    },
    {
        type: "function",
        label: "keypress",
    ...
    },
    {
        ...
        detail: "(keyCode: number) -> void",
        documentation:
            "Simulates a key release event for the specified key code",
    },
    {
        type: "function",
        label: "mouse1click",
...
export const drawingLibrary: Suggestion[] = [
    ...
    },
    {
        ...
        detail: "number",
        documentation:
            "Controls the render order (higher numbers appear on top)",
    },
    {
        type: "property",
        label: "Transparency",
...
export const cacheLibrary: Suggestion[] = [
    ...
    },
    {
        ...
        documentation:
            "Replaces object in the Instance cache with a new object",
    },
    {
        type: "function",
...
export const consoleLibrary: Suggestion[] = [
    ...
    },
    {
        ...
        detail: "() -> string",
        documentation:
            "Waits for the user to input text into the console window",
    },
    {
        type: "function",
        label: "rconsoleprint",
...
export const cryptoLibrary: Suggestion[] = [
    ...
    },
    {
        type: "function",
        label: "crypt.encrypt",
        detail: "(data: string, key: string, iv: string, mode: string) -> (string, string)",
...
export const miscFunctions: Suggestion[] = [
    ...
    },
    {
        ...
        documentation:
            "Sets the namecall method in a __namecall metatable hook",
    },
    {
        type: "function",
        label: "isluau",
...
export const uncStandardFunctions: Suggestion[] = [
    ...
    },
    {
        ...
        documentation:
            "Checks if the client has network ownership of an instance",
    },
    {
        type: "function",
        label: "getupvalue",
    ...
    },
    {
        ...
        documentation:
            "Returns the metatable of an object, bypassing __metatable",
    },
    {
        type: "function",
